...
@WebServlet("/AddReservationPaid")
public class AddReservationUnPaid extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean success = ReservationEntry.insertReservation(conn, clientId, serviceId, reservationDateTime, false);
